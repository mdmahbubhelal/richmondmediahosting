...
class Eh_Pricing_Discount_Settings extends WC_Settings_Page {
    ...
    function include_js() {
        ...
        if ($page == 'wc-settings' && $tab == "eh_pricing_discount" && ($section == "" || $section == "xa-unregistered-role" || $section == "xa-tax-option")) {
            wp_enqueue_script('jquery');
            wp_enqueue_script('eh-pricing-discount', EH_PRICING_DISCOUNT_MAIN_URL_PATH . 'includes/html-eh-price-adjustment.js');
        }
    }
    ...
    public function get_role_settings() {
        ...
        $price_sale_regular = array('sale' => __('Sale Price', 'eh-woocommerce-pricing-discount'),
            'regular' => __('Regular & Sale Price', 'eh-woocommerce-pricing-discount'));
        ...
        $settings = array(
            ...
            'price_user_role' => array(
                'title' => __('Hide Price', 'eh-woocommerce-pricing-discount'),
                'type' => 'multiselect',
                'desc' => __('Select the User Role for which you want to hide product price. This will also remove Add to Cart button.', 'eh-woocommerce-pricing-discount'),
                'class' => 'chosen_select',
            ...
            'product_choose_sale_regular' => array(
                ...
                'type' => 'select',
                'css'  => 'padding: 0px;',
                'desc' => __('Select where you want to apply the discount/markup. This is applicable to individual product level price adjustment also. If a product does not have sale price, adjustment will be applied only to the regular price.', 'eh-woocommerce-pricing-discount'),
                'default' => 'sale',
