<?php
/*
Plugin Name: QTEssentials
Plugin URI: http://www.quickerthemes.com
Description: Essential Recommended Plugins By Quicker Themes
...
add_action( 'tgmpa_register', 'QTEssentials_register_required_plugins' );

function QTEssentials_register_required_plugins() {
	...
	$plugins = array(
	   ...
	   array(
		...
		array(
            'name'               => 'WP Canvas - Shortcodes', // The plugin name.
            'slug'               => 'wc-shortcodes', // The plugin slug (typically the folder name).
            'source'             => 'http://www.quickerthemes.com/qtplugins/wc-shortcodes.zip', // The plugin source.
		...
		array(
			'name' 		=> 'Easy Featured Images',
			'slug' 		=> 'easy-featured-images',
			'required' 	=> false,
		),
		array(
			'name' 		=> 'Cssor',
