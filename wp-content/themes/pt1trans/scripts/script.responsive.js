    ...
    responsive: (function ($) {
        ...
        return function () {
            ...
            if (this.lockedResponsiveType === 'tabletlandscape' || ($("#resp-tablet-landscape").is(":visible") && this.lockedResponsiveType === '')) {
                ...
                html.addClass("wptc-responsive-tablet").removeClass("wptc-responsive-phone");
                ...
                html.addClass("wptc-responsive-phone").removeClass("wptc-responsive-tablet");
                ...
                html.removeClass("wptc-responsive-tablet wptc-responsive-phone");
...
var responsiveLayoutCell = (function ($) {
    "use strict";
    return function (responsiveDesign) {
        $(".content .content-layout-row,.footer .content-layout-row,.sidebar1 .content-layout-row,.sidebar2 .content-layout-row,.sidebar-page-top .content-layout-row,.sidebar-page-bottom .content-layout-row").each(function () {
            var row = $(this);
