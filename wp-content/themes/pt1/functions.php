...
define( 'WPTC_THEME_NAME_KEY', '_pt1' );

/* Minimum WordPress version supported is 4.3 */
if ( version_compare( $GLOBALS['wp_version'], '4.3', '<' ) ) {
    function wptc_theme_unsupported_version_admin_notice() {
        echo '<div id="theme-warning" class="error">' . sprintf( __( '<p><strong>Your current theme, %s, requires WordPress 4.3 or higher.</strong></p> <p>Please <a href="http://codex.wordpress.org/Upgrading_WordPress">upgrade WordPress</a> to use this theme.</p>', 'wptc_theme_td' ), 'pt1' ) . '</div>';
    }
    add_action( 'admin_notices', 'wptc_theme_unsupported_version_admin_notice' );
    function wptc_theme_unsupported_version_site_notice() {
        echo '</head><body>' . sprintf( __( '<p><strong>Your current theme, %s, requires WordPress 4.3 or higher.</strong></p> <p>Please <a href="http://codex.wordpress.org/Upgrading_WordPress">upgrade WordPress</a> to use this theme.</p>', 'wptc_theme_td' ), 'pt1' ) . '</body></html>';
        die();
    }
...
if ( class_exists( 'bbPress' ) ) :
    if ( version_compare( bbpress()->version, '2.5', '>=' ) ) :
        ...
        function bbpress_unsupported_version_admin_notice() {
            echo '<div id="theme-warning" class="error fade">' . sprintf( __( '<p><strong>Your current theme, %s, requires bbPress 2.5 or higher.</strong></p> <p>Please <a href="http://bbpress.org/">upgrade bbPress</a> to add support.</p>', 'wptc_theme_td' ), 'pt1' ) . '</div>';
        }
...
if ( class_exists( 'woocommerce' ) ) :
    if ( version_compare( WOOCOMMERCE_VERSION, '2.0', '>=' ) ) :
        ...
        function woocommerce_unsupported_version_admin_notice() {
            echo '<div id="theme-warning" class="error fade">' . sprintf( __( '<p><strong>Your current theme, %s, requires WooCommerce 2.0 or higher.</strong></p> <p>Please <a href="http://www.woothemes.com/woocommerce/">upgrade WooCommerce</a> to add support.</p>', 'wptc_theme_td' ), 'pt1' ) . '</div>';
        }
...
?>
<div class="wrap">
    <h2><?php _e( 'Import / Export Settings', 'wptc_theme_td' ); ?>: pt1</h2>
...
?>
<div class="wrap">
    <h2><?php _e( 'Help / Support', 'wptc_theme_td' ); ?>: pt1</h2>
    <?php
    $help_files = array();
...
<div class="wptc-content">
    <ul>
        <li><?php _e( 'Name', 'wptc_theme_td' ); ?>: pt1</li>
...
add_action( 'tgmpa_register', 'pt1_register_required_plugins' );

function pt1_register_required_plugins() {
